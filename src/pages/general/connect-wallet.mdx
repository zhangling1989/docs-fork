...
| RPC Endpoint (WSS) (primary)     | <CopyableCode code="wss://ws-gel-sepolia.inkonchain.com" />   |
| RPC Endpoint (HTTPS) (secondary) | <CopyableCode code="https://rpc-qnd-sepolia.inkonchain.com" /> |
| RPC Endpoint (WSS) (secondary)   | <CopyableCode code="wss://ws-qnd-sepolia.inkonchain.com" />   |
| Chain ID                         | 763373                                                         |
| Currency Symbol                  | ETH                                                            |
