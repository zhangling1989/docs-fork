...
Ink is an Ethereum layer 2 blockchain designed to be the house of Decentralized Finance (DeFi) for the Superchain; a powerful baselayer for deploying innovative DeFi protocols. As a natural evolution of Kraken's mission, Ink serves as a seamless bridge to DeFi, empowering users to move onchain with confidence and ease.
